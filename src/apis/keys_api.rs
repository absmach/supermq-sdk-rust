...
pub async fn get_key(configuration: &configuration::Configuration, key_id: &str) -> Result<crate::models::Key, Error<GetKeyError>> {
...
pub async fn issue_key(configuration: &configuration::Configuration, issue_key_request: crate::models::IssueKeyRequest) -> Result<(), Error<IssueKeyError>> {
    let local_var_configuration = configuration;
