...
pub async fn get_states(configuration: &configuration::Configuration, twin_id: &str, limit: Option<i32>, offset: Option<i32>) -> Result<crate::models::StatesPage, Error<GetStatesError>> {
